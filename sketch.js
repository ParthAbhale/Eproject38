...
function preload(){
    backImage  = loadImage("track1.jpg");
...
function spawnObstacle(){
  if (frameCount%80===0){
  obstacle = createSprite(200,displayHeight)
  ...
  obstacle.x = Math.round(random(displayWidth,displayHeight))
  }
}
